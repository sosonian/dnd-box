...
class Example extends Component {
    render() {
        ...
        return (
            <DnDLayout backgroundColor={"pink"} width={'100%'} height={'100%'} boxColor={''} boxHeaderColor={''} boxTabColor={'pink'} boxHeaderHoverColor={''} boxTabHoverColor={''} boxTabSelectedColor={''} iconHoverColor={''} boxTabRadius={'0px 0px 0px 0px'} boxesSetting={boxesSetting} tabHeight={40}>
                <DnDContainer containerName={"TabA"} containerID={1} boxID={2}>
                    {"TEST A Container"}
                </DnDContainer>
                <DnDContainer containerName={"TabB"} containerID={2} boxID={4}>
                    <div className="temp1">
                        {"GrandChildrenB"}
                    </div>
                </DnDContainer>            
